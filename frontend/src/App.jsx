...
function CompanionPeek({ onOpen }) { return <motion.button initial={{ x: 24 }} animate={{ x: 0 }} whileHover={{ x: -5 }} onClick={onOpen} className="companion-peek" aria-label="Open Grindly companion"><GrindlyCharacter mood="idle" size="sm" /><span className="companion-peek-label">Grindly</span></motion.button>; }
